...
if(! defined('FILE_CACHE_TIME_BETWEEN_CLEANS'))	define ('FILE_CACHE_TIME_BETWEEN_CLEANS', 365 * 86400);	// How often the cache is cleaned
...
//Browser caching
if(! defined('BROWSER_CACHE_MAX_AGE') ) 	define ('BROWSER_CACHE_MAX_AGE', 365 * 86400);				// Time to cache in the browser
...
class timthumb {
    ...
    protected function calcDocRoot(){
        ...
        $this->docRoot = str_replace('frontend/web','backend/web',$this->docRoot);
